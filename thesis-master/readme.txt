...
test_one_file.py. This does checking of the predicted class label at frame level. Usage is as follows:
 ...
 python3 serverCODDO.py --input=sld/videos --max-frames=2000  --fps=5 --fc1_layer=True --video_id=HUMEcnkvhJU --timesteps=20 --model=/sld/rnn.h5 --output=/sld --gt=sld/groundtruth.txt
